...
- `REACT_APP_BEE_UPLOAD_APIS` - comma separated bee API URLs through which the gateway uploads. The api to upload is
  selected at random (defaults to `[http://localhost:1633]`)
